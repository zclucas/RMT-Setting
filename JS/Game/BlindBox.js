    ...
    const datas = [
        {
            ...
            // originalAuthor: "若梦兔",
            author: "Nimoll",
            feature: "减少游戏盲盒派对的重复性无意义操作，做日常，自动打关，过剧情等。可通过菜单宏在滚轮原功能和选角色进行切换，右键卖出角色，简化操作难度。功能全面，涵盖游戏内几乎所有需要用到宏的地方",
            steps: [
                "适配笔记本2.5k（2560*1600）屏幕，只能前台操作。因较复杂，其他分辨率自行调整难度较高，已将大部分操作拆开到宏页面中以降低调整难度，单像素颜色识别也在文字识别中加了注释。",
