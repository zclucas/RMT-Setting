document.addEventListener("DOMContentLoaded", () => {
    ...
    const datas = [
        ...
        },
        {
            ...
            title: "不死突袭3-自动加弹",
            author: "光H暗",
            feature: "机枪手角色弹药掌控天赋自动加弹",
            steps: [
                "回车键打开聊天框时会结束自动加弹,需要再次按小键盘0开启;",
                "聊天框会挡住弹药量,导致读取失败;",
                "前台选择了星际争霸2,不在其他地方触发了",
            ],
            file: "../../游戏宏/星际争霸/自动加弹/ua3AR1.1.rmt",
        },
        {
            id: "不死突袭3-前线角色快捷设置",
            title: "不死突袭3-前线角色快捷设置",
            author: "光H暗",
            feature: "不死突袭3前线角色快捷设置",
            steps: [
                "小键盘1到9选择飞机方向;",
                "小键盘0设置两种火炮模式",
            ],
            file: "../../游戏宏/星际争霸/角色快捷设置/ua3前线.rmt",
        },
        // 可以继续添加更多条目
    ];
